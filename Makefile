...
CPPFLAGS = 
CYGPATH_W = echo
DEFS = -DPACKAGE_NAME=\"rmw\" -DPACKAGE_TARNAME=\"rmw\" -DPACKAGE_VERSION=\"2016.08.02.01a\" -DPACKAGE_STRING=\"rmw\ 2016.08.02.01a\" -DPACKAGE_BUGREPORT=\"andyqwerty@users.sourceforge.net\" -DPACKAGE_URL=\"\" -DPACKAGE=\"rmw\" -DVERSION=\"2016.08.02.01a\" -DSTDC_HEADERS=1 -DHAVE_SYS_TYPES_H=1 -DHAVE_SYS_STAT_H=1 -DHAVE_STDLIB_H=1 -DHAVE_STRING_H=1 -DHAVE_MEMORY_H=1 -DHAVE_STRINGS_H=1 -DHAVE_INTTYPES_H=1 -DHAVE_STDINT_H=1 -DHAVE_UNISTD_H=1 -DHAVE__BOOL=1 -DHAVE_STDBOOL_H=1
DEPDIR = .deps
ECHO_C = 
ECHO_N = -n
ECHO_T = 
...
PACKAGE_NAME = rmw
PACKAGE_STRING = rmw 2016.08.02.01a
PACKAGE_TARNAME = rmw
PACKAGE_URL = 
PACKAGE_VERSION = 2016.08.02.01a
PATH_SEPARATOR = :
SET_MAKE = 
SHELL = /bin/bash
STRIP = 
VERSION = 2016.08.02.01a
...
SUBDIRS = src etc
EXTRA_DIST = COPYING ChangeLog README.txt AUTHORS BUGS TODO INSTALL rmwc_config.example
